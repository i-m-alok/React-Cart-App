        ...
        <Table>
          ...
          <TableBody id="shoppingCart">
            ...
            <TableRow id="shippingRow">
              ...
              <TableCell></TableCell>
              <TableCell align="center">
                $ {props.subTotal > 50 || props.subTotal === 0 ? 0 : 3.0}
              </TableCell>
            </TableRow>
            <TableRow id="taxRow">
            ...
            <TableRow id="totalPriceRow">
              ...
              <TableCell align="center">
                ${" "}
                {props.subTotal > 50 || props.subTotal === 0
                  ? props.subTotal + props.subTotal * 0.05
                  : props.subTotal + props.subTotal * 0.05 + 3.0}
              </TableCell>
            </TableRow>
          </TableBody>
        </Table>
